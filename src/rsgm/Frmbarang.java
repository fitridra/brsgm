...
public class Frmbarang extends javax.swing.JDialog {
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if (!"".equals(row_txtnama) && !"".equals(row_txtsatuan) && !"".equals(row_txtharga) && !"".equals(row_txtstok)) {
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT COUNT(tb_barang.id_barang) as count FROM tb_barang");
                sql.next();
            ...
            if ("".equals(row_id)) {
                if (c_kode == 0) {
                    ...
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO tb_barang(nm_barang, harga, satuan, stok_gudang) VALUES ('" + row_txtnama + "', '" + row_txtharga + "', '" + row_txtsatuan + "', '" + row_txtstok + "')");
                ...
                if (c_kode == 0 || row_id.equals(row_id)) {
                    try {
                        Connection conn = konek.openkoneksi();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("UPDATE tb_barang SET nm_barang='" + row_txtnama + "',harga='" + row_txtharga + "',satuan='" + row_txtsatuan + "',stok_gudang='" + row_txtstok + "' WHERE id_barang = '" + row_id + "'");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if (ok == 0) {
            try {
                ...
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("DELETE FROM tb_barang WHERE id_barang = '" + row_id + "'");
