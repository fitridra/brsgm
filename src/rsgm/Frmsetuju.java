...
public class Frmsetuju extends javax.swing.JDialog {
    ...
    public Frmsetuju(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void GetData(){
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT * FROM tb_permintaan_detail");
            ...
            Logger.getLogger(Frmsetuju.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        btnadd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rsgm/img/add.png"))); // NOI18N
        ...
        btndelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rsgm/img/delete.png"))); // NOI18N
        ...
        if(!"0".equals(row_id)){
            try {
                ...
                if(sql.next()){
                    ...
                    String kode = sql.getString("id_permintaan_detail");
                    ...
                    txtrole.setSelectedItem(sql.getString("stok_ruangan"));
                    txtruangan.setText(sql.getString("jumlah_diminta"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frmsetuju.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Frmsetuju dialog = new Frmsetuju(new javax.swing.JFrame(), true);
